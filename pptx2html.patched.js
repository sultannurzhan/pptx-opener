    ...
    if (trNodes.constructor === Array) {
      for (var i = 0; i < trNodes.length; i++) {
        ...
        if (i === 0 && firstRowAttr !== undefined && thisTblStyle !== undefined) {
          ...
          if (thisTblStyle && thisTblStyle['a:firstRow'] !== undefined) {
          ...
          if (i % 2 === 0) {
            if (thisTblStyle && thisTblStyle['a:band2H'] !== undefined) {
            ...
            if (thisTblStyle && thisTblStyle['a:band1H'] !== undefined) {
  ...
  */
  ...
  function getSchemeColorFromTheme(schemeClr, sldMasterNode) {
    ...
    switch (schmClrName) {
      ...
      case 'bg2':
        {
          schemeClr = 'a:' + (slideLayoutClrOvride ? slideLayoutClrOvride[schmClrName] || 'lt1' : 'lt1'); // console.log(schmClrName+ "=> "+schemeClr);
